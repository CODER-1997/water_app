    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (snapshot.hasData) {
            return snapshot.data!.docs.where((element) => element['items']['status']=='rejected').length != 0
                ? GroupedListView(
              ...
              itemBuilder: (c, element) {
                return element['items']['customerId'] ==
                    GetStorage().read('userId').toString() && element['items']['status']=='rejected'
                    ? Container(
