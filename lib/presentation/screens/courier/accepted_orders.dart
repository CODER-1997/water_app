            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              if (snapshot.hasData) {
                var list = snapshot.data!.docs
                    .where((element) =>
                element['items']['status'] == 'accepted' && element['items']['courierId']==box.read('courierId') &&
                ...
                return list.length != 0
                  ...
                  itemBuilder: (c, element) {
                    return element['items']['companyId']
                        ...
                        box
                            .read('companyId')
                            .replaceAll(" ", '').toString().toLowerCase() && element['items']['courierId']==box.read('courierId') &&
                        element['items']['status'] == 'accepted'
                        ? Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          element['items']['status'] =='accepted'
                              ? GestureDetector(
                            onTap: () {
                              if (element['items']['status'] =='accepted') {
                                orderController
                                    .finishOrder(element.id);                                // courierController.addHistory(
                                //     box.read('courierId'),
                                //     element.id);
                              }
                            },
