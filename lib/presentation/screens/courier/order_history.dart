            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              if (snapshot.hasData) {
                var list = snapshot.data!.docs
                    .where((element) =>
                element['items']['status'] == 'finished' && element['items']['courierId']==box.read('courierId') &&
                    ...
                    return element['items']['companyId']
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Item(
                            title:
                            '${'status'.tr.capitalizeFirst}:',                            value: element['items']['status'],
