...
class Products extends StatelessWidget {
  ...
  List subtitle=['Javohir waterda 4 ta oling 1 ta tekin','Fayz suvlarida 5 ta oling 1 ta tekin'];
  List images=['img_3','img_2'];
  List colors=[[Color(0xFF2495FF), Color(0xFF2B7FC9)],[Color(0xFF1BC27A),Color(0xFF4FE48A)]];
          ...
          child: Column(
            children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      '$i',
                                      style: TextStyle(fontSize: 26.0,color: Colors.white,fontWeight: FontWeight.w900),
                                    ),  Text(
                                      '${subtitle[titles.indexOf(i)]}',
                                      style: TextStyle(fontSize: 16.0,color: Colors.white,fontWeight: FontWeight.w900),
                                    ),
                                  ],
                                ),
                              ),
                              Expanded(
                                child: Container(
                                  width: 200,
                                    child: Image.asset('assets/images/order_card/${images[titles.indexOf(i)]}.png',)),
                              )
                            ],
                          ));
                    },
              ...
              OrderCard(
                ...
                discountRate: 5, companyPhone: '+998 93 319 80 04',
              ),
              OrderCard(
                title: 'Javohir water',
                price: '8000',
                ...
                discountRate: 4, companyPhone: '+998 94 338 77 00',
              )
            ],
          ),
        ),
